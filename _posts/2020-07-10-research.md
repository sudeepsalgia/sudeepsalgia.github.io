...
- facilitate \emph{provably efficient, interpretable, adaptive} data-driven decision-making;
- investigate \emph{fundamental trade-offs} in distributed learning problems;
- design optimal solutions that comply with \emph{practical systemic limitations such as communication, privacy, and computation}.
